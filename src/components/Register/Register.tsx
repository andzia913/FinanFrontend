                    ...
                    <form onSubmit={handleSubmit}>
                        <FormControl>
                            ...
                            <Input
                                ...
                                aria-invalid={validName ? 'false' : 'true'}
                            />
                            <FormHelperText id="uidnote" className={name && !validName ? 'instructions' : 'offscreen'}>
                                <Info />
                                4 to 24 characters.<br />
                                Must begin with a letter.<br />
                                Letters, numbers, underscores, hyphens allowed.
                        ...
                        <FormControl>
                            ...
                            />
                            <FormHelperText id="pwdnote" className={password && !validPassword ? 'instructions' : 'offscreen'}>
                                <Info />
                        ...
                        <FormControl>
                            <InputLabel htmlFor="confirm_pwd">
                                Confirm Password:
                                <Check className={validMatch && matchPassword ? 'valid' : 'hide'} />
                                <Close
                            ...
                            />
                            <FormHelperText id="confirmnote" className={matchPassword && !validMatch ? 'instructions' : 'offscreen'}>
                                <Info />
